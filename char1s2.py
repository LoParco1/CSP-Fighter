...
filecurent = "char12"
window = Tk()
window.title('Player 1: Choose Second Character')
...
if str(p1[0]) != "Placeholder" and str(p2[0]) != "Placeholder":
...
#Nevil Character
if str(p1[0]) != "Nevil" and str(p2[0]) != "Nevil":
	#^^^checks if player 1 selected character
...
#Donald?
if str(p1[0]) != "Donald" and str(p2[0]) != "Donald":
...
if str(p1[0]) != "Gavin" and str(p2[0]) != "Gavin":
	#gavin
...
if str(p1[0]) != "Rhys" and str(p2[0]) != "Rhys":
	#Rhys
...
if str(p1[0]) != "Joey" and str(p2[0]) != "Joey":
	#Joey
...
if str(p1[0]) != "Drew" and str(p2[0]) != "Drew":
...
if str(p1[0]) != "Eli" and str(p2[0]) != "Eli":
